...
//    // Msg Delay
//    // CS & CS
//    public void onAddDelay(int frame, int endFrame, int delay) {
//
...
//
//    //Speed
//    public void onAddSpeedRange(int frame, int left, int top, int right, int bottom, Object value) {
//
//        stimuli.add(new Speed(this, frame, new Range(left, top, right, bottom), value));
//
//    }
//
//    public void onAddSpeedAllA(int frame, Object value) {
//
//        stimuli.add(new Speed(this, frame, AmbulanceNames, value));
//
//    }
//
//    public void onAddSpeedAllF(int frame, Object value) {
//
//        stimuli.add(new Speed(this, frame, firefighterNames, value));
//
//    }
//
//    public void onAddSpeedOneA(int frame, int number, Object value) {
//
//        stimuli.add(new Speed(this, frame, "Ambulance" + number, value));
//
//    }
//
//    public void onAddSpeedOneF(int frame, int number, Object value) {
//
...
//
//    //Sight
//    public void onAddSightRange(int frame, int left, int top, int right, int bottom, Object value) {
//
//        stimuli.add(new SightRange(this, frame, new Range(left, top, right, bottom), value));
//
//    }
//
//    public void onAddSightAll(int frame, Object value) {
//
//        stimuli.add(new SightRange(this, frame, firefighterNames, value));
//
//    }
//
//    public void onAddSightOne(int frame, int number, Object value) {
//
...
//
//    //Remove
//    public void onRemoveFireFighter(int frame, int number) {
//
//        stimuli.add(new RemoveEntity(this, frame, "FF" + number, this::removeCS));
//
//    }
//
//    public void onRemoveAmbulance(int frame, int number) {
//
...
//
//    //Communication Range
//    public void onAddCommunicationRRange(int frame, int left, int top, int right, int bottom, Object value) {
//
//        stimuli.add(new CommunicationRange(this, frame, new Range(left, top, right, bottom), value));
//
//    }
//
//    public void onAddCommunicationRAll(int frame, Object value) {
//
//        stimuli.add(new CommunicationRange(this, frame, firefighterNames, value));
//
//    }
//
//    public void onAddCommunicationROne(int frame, int number, Object value) {
//
...
//
//    //Injury
//    public void onAddInjury(int frame, int number) {
//
...
//
//    //Injury
//    public void onAddLoss(int frame, int endframe) {
//
