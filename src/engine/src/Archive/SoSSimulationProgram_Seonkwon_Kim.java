            ...
            case "add":
                ...
                switch (command) {
                    ...
                    case "firefighter":
                        ...
                        break;
                    case "delay":
                        world.onAddDelay(input.nextInt(), input.nextInt(), input.nextInt());
                        break;
                    case "speed":
                        command = input.next().toLowerCase();
                        switch (command) {
                            case "Range":
                                world.onAddSpeedRange(input.nextInt(), input.nextInt(), input.nextInt(), input.nextInt(), input.nextInt(), input.nextFloat());
                                break;
                            case "all":
                                world.onAddSpeedAllF(input.nextInt(), input.nextFloat());
                                break;
                            case "one":
                                world.onAddSpeedOneF(input.nextInt(), input.nextInt(), input.nextFloat());
                                break;
                        }
                        break;
                    case "sight":
                        ...
                        switch (command) {
                            case "range":
                                world.onAddSightRange(input.nextInt(), input.nextInt(), input.nextInt(), input.nextInt(), input.nextInt(), input.nextFloat());
                                break;
                            case "all":
                                world.onAddSightAll(input.nextInt(), input.nextInt());
                                break;
                            case "one":
                                world.onAddSightOne(input.nextInt(), input.nextInt(), input.nextFloat());
                                break;
                        }
                        world.onAddSightRange(input.nextInt(), input.nextInt(), input.nextInt(), input.nextInt(), input.nextInt(), input.nextFloat());
                        break;
                    case "communication":
                        ...
                        switch (command) {
                            case "range":
                                world.onAddCommunicationRRange(input.nextInt(), input.nextInt(), input.nextInt(), input.nextInt(), input.nextInt(), input.nextFloat());
                                break;
                            case "all":
                                world.onAddCommunicationRAll(input.nextInt(), input.nextFloat());
                                break;
                            case "one":
                                world.onAddCommunicationROne(input.nextInt(), input.nextInt(), input.nextFloat());
                                break;
                        }
                        break;
                    case "injury":
                        world.onAddInjury(input.nextInt(), input.nextInt());
                        break;
                    case "loss":
                        world.onAddLoss(input.nextInt(), input.nextInt());
                        break;
                }
                break;
            case "remove":
                ...
                switch (command) {
                    case "ambulance":
                        world.onRemoveAmbulance(input.nextInt(), input.nextInt());
                        break;
                    case "firefighter":
                        world.onRemoveAmbulance(input.nextInt(), input.nextInt());
                        break;
    ...
    private void beginnerMode() {
        ...
        switch (command) {
            case 1:
                ...
                switch (command) {
                    case 1: {
                        ...
                        switch (command) {
                            case 1: {
                                ...
                                world.onAddSpeedOneA(frameN, number, value);
                                break;
                            }
                            case 2: {
                                int frameN = getCommandOnBeginnerMode("frame count: ");
                                Object value = getCommandOnBeginnerModeF("speed: ");
                                world.onAddSpeedAllA(frameN, value);
                                break;
                            }
                        }
                        break;
                    ...
                    case 2: {
                        ...
                        switch (command) {
                            case 1: {
                                ...
                                Object value = getCommandOnBeginnerModeF("speed: ");
                                world.onAddSpeedOneF(frameN, number, value);
                                break;
                            }
                            case 2: {
                                int frameN = getCommandOnBeginnerMode("frame count: ");
                                Object value = getCommandOnBeginnerModeF("speed: ");
                                world.onAddSpeedAllF(frameN, value);
                                break;
                            }
                        }
                        break;
                    ...
                    case 3: {
                        ...
                        Object value = getCommandOnBeginnerModeF("speed: ");
                        world.onAddSpeedRange(frameN, left, top, right, bottom, value);
                        break;
                    }
                }
                break;
                    ...
                    case 1: {
                        ...
                        switch (command) {
                            case 1: {
                                ...
                                world.onAddSightOne(frameN, number, value);
                                break;
                            }
                            case 2: {
                                int frameN = getCommandOnBeginnerMode("frame count: ");
                                Object value = getCommandOnBeginnerModeF("sight: ");
                                world.onAddSightAll(frameN, value);
                                break;
                            }
                            case 3: {
                                int frameN = getCommandOnBeginnerMode("frame count: ");
                                ...
                                int bottom = getCommandOnBeginnerMode("range of bottom: ");
                                Object value = getCommandOnBeginnerModeF("sight: ");
                                world.onAddSightRange(frameN, left, top, right, bottom, value);
                                break;
                            }
                        }
                        break;
                    ...
                    case 2: {
                        ...
                        switch (command) {
                            case 1: {
                                ...
                                world.onAddCommunicationROne(frameN, number, value);
                                break;
                            }
                            case 2: {
                                int frameN = getCommandOnBeginnerMode("frame count: ");
                                Object value = getCommandOnBeginnerModeF("communication range: ");
                                world.onAddCommunicationRAll(frameN, value);
                                break;
                            }
                            case 3: {
                                int frameN = getCommandOnBeginnerMode("frame count: ");
                                ...
                                int bottom = getCommandOnBeginnerMode("range of bottom: ");
                                Object value = getCommandOnBeginnerModeF("communication range: ");
                                world.onAddCommunicationRRange(frameN, left, top, right, bottom, value);
                                break;
                            }
                        }
                        break;
            ...
            case 3:
                ...
                switch (command) {
                    case 1: {
                        ...
                        world.onAddDelay(frameN, endFrameN, delay);
                        break;
                    }
                    case 2: {
                        int frameN = getCommandOnBeginnerMode("frame count: ");
                        int endframeN = getCommandOnBeginnerMode("endframe count: ");
                        world.onAddLoss(frameN, endframeN);
                        break;
                    }
                }
                break;
            ...
            case 4:
                ...
                switch (command) {
                    case 1: {
                        ...
                        world.onAddFireFighter(frameN, number);
                        break;
                    }
                    ...
                    case 2: {
                        ...
                        world.onAddAmbulance(frameN, number);
                        break;
                    }
                }
                break;
            ...
            case 5:
                ...
                switch (command) {
                    case 1: {
                        int frameN = getCommandOnBeginnerMode("frame count: ");
                        int number = getCommandOnBeginnerMode("firefighter number: ");
                        world.onRemoveFireFighter(frameN, number);
                        break;
                    }
                    case 2: {
                        int frameN = getCommandOnBeginnerMode("frame count: ");
                        int number = getCommandOnBeginnerMode("ambulance number: ");
                        world.onRemoveAmbulance(frameN, number);
                        break;
                    }
                }
                break;
            ...
            case 6:
                int frameN = getCommandOnBeginnerMode("frame count: ");
                int number = getCommandOnBeginnerMode("firefighter number: ");
                world.onAddInjury(frameN, number);
                break;
