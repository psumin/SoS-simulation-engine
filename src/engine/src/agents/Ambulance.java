...
public class Ambulance extends CS{
    ...
    public Ambulance(World world, String name) {
        super(world, name);
        router = world.router;
        transferImage = new ImageObject("D://SoS-simulation-engine/src/engine/resources/transfer2.png");
        defaultImage = new ImageObject("D://SoS-simulation-engine/src/engine/resources/ambulance1.png");
