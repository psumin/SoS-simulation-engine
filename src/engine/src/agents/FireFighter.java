...
public class FireFighter extends CS {
    ...
    public FireFighter(World world, String name) {
        ...
        transferImage = new ImageObject("D://SoS-simulation-engine/src/engine/resources/transfer1.png");
        defaultImage = new ImageObject("D://SoS-simulation-engine/src/engine/resources/firefighter1.png");
        moveToPatient = new ImageObject("D://SoS-simulation-engine/src/engine/resources/moveToPatient1.png");
        firstAid = new ImageObject("D://SoS-simulation-engine/src/engine/resources/firstAid.png");
