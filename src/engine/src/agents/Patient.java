...
public class Patient extends CS {
   ...
   public enum Status {
    ...
    private int seriousTreatmentTime = 75;                              // Hospital's treatment time for Serious patient
    private int woundedTreatmentTime = 75;                               // Hospital's treatment time for Wounded patient
