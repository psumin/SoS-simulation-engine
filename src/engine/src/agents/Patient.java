...
public class Patient extends CS {
   ...
   public enum Status {
    ...
    private int seriousTreatmentTime = 30;                              // Hospital's treatment time for Serious patient
    private int woundedTreatmentTime = 30;                               // Hospital's treatment time for Wounded patient
